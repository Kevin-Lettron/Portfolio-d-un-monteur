...
<form method="post" enctype="multipart/form-data" action="">
    ...
    $themes = executeRequete("SELECT * FROM theme");
    while ($ligne = $themes->fetch_assoc()){
        echo '<option value='.$ligne["id_theme"];
        if (isset($article_actuel) && $article_actuel['theme'] == $ligne['id_theme']) echo 'selected';
        echo'>'.$ligne["nom_theme"].'</option>';
    }
